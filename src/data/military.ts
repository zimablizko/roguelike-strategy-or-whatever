...
export const unitDefinitions = {
  ...
  footman: {
    ...
    trainingCost: { gold: 25, materials: 10, food: 10 },
    trainingTime: 2,
    tags: ['infantry', 'heavy'],
  ...
  archer: {
    ...
    trainingCost: { gold: 20, materials: 5, food: 5 },
    trainingTime: 2,
    tags: ['ranged', 'light'],
    requiredTechnologies: ['mil-drill-doctrine'],
  },
  ...
  engineer: {
    ...
    class: 'specialist',
    power: 1,
    upkeep: { gold: 2, materials: 1 },
    trainingCost: { gold: 35, materials: 15 },
    trainingTime: 3,
